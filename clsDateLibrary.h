...
public:
	 ...
	 void GetDateFromDayOrder(short DayOrder)
	{
	 ...
	 static bool IsOverLapPeriod(clsDateLibrary Date1Start, clsDateLibrary Date1End, clsDateLibrary Date2Start, clsDateLibrary Date2End)
	 {
		 return !(CompareDate(Date1End, Date2Start) == 1 || CompareDate(Date2End, Date1Start) == 1);
	 }

	 bool IsOverLapPeriod(clsDateLibrary Date1End, clsDateLibrary Date2Start,clsDateLibrary Date2End)
	 {
		 return IsOverLapPeriod(*this, Date1End, Date2Start, Date2End);
	 }
	 ...
	 static int PeriodDays(clsDateLibrary Date1Start, clsDateLibrary Date1End, clsDateLibrary Date2Start, clsDateLibrary Date2End)
	 {
		 ...
		 clsDateLibrary IntersectEnd = IsDate1BeforeDate2(Date2End, Date2End) ? Date1End : Date2End;
	 ...
	 {
		 return !(Date.Month > 12 || Date.Day > NumberOfDaysInMonth(Date.Year, Date.Month));
	 }
